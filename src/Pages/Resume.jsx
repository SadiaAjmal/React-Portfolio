...
const resumeItems = [
    ...
    {
        icon: <FaPuzzlePiece className="w-7 h-7 text-white" />,
        text: "Certified Web Developer",
    },
    {
        icon: <MdAutoAwesome className="w-7 h-7 text-white" />,
        ...
        <section className="w-full px-6 py-10">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between items-start md:items-center min-h-[320px]">
                ...
                <div className="flex-1 mb-10 md:mb-0">
                    ...
                    <button
                        className="group relative inline-flex items-center justify-center overflow-hidden rounded-md bg-black px-6 py-2 text-base font-semibold text-white transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-xl hover:shadow-black/50"
                    >
                ...
                <div className="flex-1 flex flex-col gap-8 md:pl-16">
                    {resumeItems.map((item, idx) => (
                        <div key={idx} className="flex items-center">
                            <div className="bg-gray-800 rounded-lg shadow-md flex items-center justify-center w-14 h-14 mr-4">
                                {item.icon}
                            </div>
